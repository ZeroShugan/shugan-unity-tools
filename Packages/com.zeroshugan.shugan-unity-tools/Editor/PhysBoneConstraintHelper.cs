...
namespace ShuganTools
{
    public class PhysBoneConstraintHelper : EditorWindow
    {
        ...
        [MenuItem("Tools/Shugan/PhysBone & Constraint Helper", false, 1924)]
        ...
        void OnGUI()
        {
            ...
            ShuganToolUI.DrawHeader("VRC PhysBone & Constraint Helper");
            ...
            ShuganToolUI.DrawCredits("PhysBone & Constraint Helper", ToolVersion);
