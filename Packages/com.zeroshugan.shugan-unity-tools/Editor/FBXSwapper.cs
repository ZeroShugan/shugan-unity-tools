...
namespace ShuganTools
{
    public class FBXSwapper : EditorWindow
    {
        ...
        public GameObject newFbxModel;
        public GameObject oldFbxToReplace;

        // Settings
        public string scenePrefabFolder = "Assets/! Shugan/!_Prefabs/Custom/_Generated";
        public bool addToSceneAfterCreation = true;
        public bool suppressCompletionDialog = false;
        ...
        const string WikiUrl = "https://www.notion.so/shugan/FBX-Swapper-253d98525501802ca7c9e7eb7738e0ec";
        const string ToolVersion = "1.0";

        [MenuItem("Tools/Shugan/FBX Swapper", false, 1923)]
        ...
        void OnGUI()
        {
            ...
            ShuganToolUI.DrawHeader("FBX Model Swapper");
            ...
            ShuganToolUI.DrawCredits("FBX Swapper", ToolVersion);
        ...
        public static string ExecuteSwap(
            GameObject targetPrefab, GameObject newFbxModel, GameObject oldFbxToReplace,
            string outputFolder = null, bool instantiateInScene = false)
        {
            var inst = CreateInstance<FBXSwapper>();
            inst.targetPrefab              = targetPrefab;
            inst.newFbxModel               = newFbxModel;
            inst.oldFbxToReplace           = oldFbxToReplace;
            if (outputFolder != null) inst.scenePrefabFolder = outputFolder;
            inst.addToSceneAfterCreation   = instantiateInScene;
            inst.suppressCompletionDialog  = true;
            return inst.CreateAlternativePrefab();
        }

        public string CreateAlternativePrefab()
        {
            string result = null;
            ...
            try
            {
                if (isSceneObject)
                {
                    ...
                    if (workingPrefab == null) return null;
